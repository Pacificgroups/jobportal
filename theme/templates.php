	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item <?php if (!isset($_GET['q'])) {
  echo 'active';
}?>"><a href="<?php echo web_root; ?>" class="nav-link">Home</a></li> 
...
}?>"><a class="nav-link"  href="<?php echo web_root; ?>index.php?q=company">Company</a></li>
            <li class="nav-item <?php if (isset($_GET['q'])) {
  if ($_GET['q'] == 'hiring') {
    echo 'active';
  }
...
}?>"><a  class="nav-link" href="<?php echo web_root; ?>index.php?q=hiring">Hiring Now</a></li>
            <li class="nav-item <?php if (isset($_GET['q'])) {
  if ($_GET['q'] == 'About') {
    echo 'active';
  }
...
}?>"><a  class="nav-link" href="<?php echo web_root; ?>index.php?q=About">About Us</a></li>
            <li class="nav-item <?php if (isset($_GET['q'])) {
  if ($_GET['q'] == 'Contact') {
    echo 'active';
  }
...
}?>"><a  class="nav-link" href="<?php echo web_root; ?>index.php?q=Contact">Contact</a></li>
            <?php if (!isset($_SESSION['APPLICANTID'])) { ?>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Wipro Limited

Plot No 480-481,
Udyog Vihar, Phase - III 
Gurgaon – 122016, Haryana</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text"> +91 124 308 4000</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">contact@wipro.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://wipro.com" target="_blank">Internship Group 53</a>
